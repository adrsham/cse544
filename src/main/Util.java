...
public class Util {
    ...
    public static Table parseStringAndQueryToTable(ZQuery query, String stringInput) {
        ...
        TableDescriptor td = parseQueryToTableDescriptor(query, lines[0]);
        return parseTDAndArrayToTable(td, lines);
    }

    /**
     * parse query to table descriptor
     * @param query
     * @param stringTD
     * @return
     */
    @SuppressWarnings("unchecked")
    public static TableDescriptor parseQueryToTableDescriptor(ZQuery query, String stringTD) {
        List<String> name = new ArrayList<String>();
        List<String> alias = new ArrayList<String>();
        List<String> table = new ArrayList<String>();
        List<Type> type = new ArrayList<Type>();

        String[] line = stringTD.split("\t");
        int curCol = 0;     
        ...
        return new TableDescriptor(type, name, alias, table);
    }
    ...
    private static Table parseTDAndArrayToTable(TableDescriptor td, String[] lines) {
